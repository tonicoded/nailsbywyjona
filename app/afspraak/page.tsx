...
export default function BookingPage() {
  return (
    <main>
      ...
      <section className="planner-section section-shell" data-reveal><div className="planner-intro"><p className="eyebrow"><span /> Jouw voorkeur</p><h2>Stuur je<br /><em>aanvraag.</em></h2><p>Je ingevulde aanvraag wordt voor je gekopieerd. Daarna opent Instagram, zodat je het bericht direct naar Wyjona kunt sturen.</p></div><BookingPlanner /></section>
