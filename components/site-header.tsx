...
export function SiteHeader() {
  return (
    <header className="site-header">
      <Link href="/afspraak" className="prelaunch-bar"><span /> Nog niet geopend — Nails By Wyjona opent binnenkort in Sneek <span /></Link>
      <div className="nav-shell">
        ...
        <Link href="/afspraak" className="nav-cta">Binnenkort open <ArrowUpRightIcon className="header-arrow" width={18} height={18} /></Link>
        <details className="mobile-menu">
          ...
          <div className="mobile-menu-panel">
            ...
            <Link href="/afspraak" className="mobile-booking-link">Bekijk openingsnieuws <ArrowUpRightIcon className="header-arrow" width={18} height={18} /></Link>
