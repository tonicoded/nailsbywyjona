  ...
  return (
    <header className="site-header">
      <div className="nav-shell">
        ...
        <Link href="/afspraak" className="nav-cta">Plan je afspraak <ArrowUpRightIcon className="header-arrow" width={18} height={18} /></Link>
        <details className="mobile-menu">
          ...
          <div className="mobile-menu-panel">
            ...
            <Link href="/afspraak" className="mobile-booking-link">Plan je afspraak <ArrowUpRightIcon className="header-arrow" width={18} height={18} /></Link>
